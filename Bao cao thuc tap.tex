...
\hspace{1cm} - Giấy phép kinh doanh ( MS Thuế ): 0315854277 
- ngày cấp: 17/08/2019.
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{bao gia 2}
  \caption{Báo giá khối lượng dây điện}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.6]{bao gia 3}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[scale=0.3]{bao tri}
